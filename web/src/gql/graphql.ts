...
export type CreateFrameMutation = { createFrame: { id: string, orderIndex: number, originalUrl: string, processedUrl: string | null, rotation: number, scale: number, offsetX: number, offsetY: number, width: number | null, height: number | null } };
